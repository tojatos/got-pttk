# Generated by Django 3.1.4 on 2020-12-26 04:18
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Uzytkownik',
            fields=[
                ('login', models.CharField(db_column='Login', max_length=255, primary_key=True, serialize=False)),
                ...
                ('rola', models.ForeignKey(db_column='Rola', on_delete=django.db.models.deletion.DO_NOTHING, to='core.rola')),
            ],
            options={
                'db_table': 'Uzytkownik',
            },
